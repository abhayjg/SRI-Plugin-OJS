...
final class SriMetadataBuilder
{
    ...
    /**
     * Fill manual suffix for a specifically named suffix field (future-proof).
     */
    ...
    {
        // 3.4+: getData('orcid') returns a PKP\orcid\Orcid object with getPath();
        // legacy sites store the raw ORCID iD string on the 'orcid' field.
